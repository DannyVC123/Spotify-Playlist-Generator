...
class WebService:
    @staticmethod
    def call(url, action, status_codes, good_codes=True, headers=None, params=None, data=None):
        ...
        try:
            ...
            while True:
                ...
                if good_codes and response.status_code in status_codes:
                    break
                elif not good_codes and response.status_code not in status_codes:
                    break
