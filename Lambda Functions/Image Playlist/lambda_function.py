...
def lambda_handler(event, context):
    try:
        ...
        required_fields = ['labels', 'playlist_name']
        ...
        response = generate_image_playlist(chatgpt_client, spotify_client,
                                           labels, playlist_name, limit, public)
        return response
...
def generate_image_playlist(chatgpt_client, spotify_client, labels, playlist_name, limit=10, public=False):
